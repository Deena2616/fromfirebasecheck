...
class _GeneratedPageState extends State<GeneratedPage> {
  ...
  Future<void> _submitForm() async {
    ...
    for (var el in pageData['elements']) {
      if (el['type'] == ElementType.textField) {
        final fieldName = el['fieldName'];
        if (fieldName != null && fieldName.isNotEmpty) {
          formData[fieldName] = _controllers[el['fieldId']]?.text ?? '';
        }
      }
    }
          ...
          children: [
            ...
            child: Container(
              ...
              child: Opacity(
                opacity: 1,
                child: TextField(
                  controller: _controllers['field_1756125785902'],
            ...
            child: Container(
              ...
              child: Opacity(
                opacity: 1,
                child: TextField(
                  controller: _controllers['field_1756125788130'],
                  decoration: InputDecoration(
                    labelText: 'mail',
                    hintText: 'Enter text',
                    border: OutlineInputBorder(),
            ...
            child: Container(
              ...
              child: Opacity(
                opacity: 1,
                child: TextField(
                  controller: _controllers['field_1756125799759'],
                  decoration: InputDecoration(
                    labelText: 'password',
                    hintText: 'Enter text',
                    border: OutlineInputBorder(),
